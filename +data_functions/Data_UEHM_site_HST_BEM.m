%Heinrichstraße - Status Quo mit BEM, AC off, completely impervious roof

function[WallLayers,ParSoilRoof,ParSoilGround,ParInterceptionTree,...
	PropOpticalTree,...
	ParThermalBulidingInt,ParThermalTree,...
	ParVegRoof,ParVegGround,ParVegTree,...
    PropOpticalRoof,PropOpticalIndoors,ParWindows,ParHVAC,BEM_on]=Data_UEHM_site_HST_BEM(MeteoData,varargin)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Height_canyon	=	21.0;				% Canyon (building) height (m)
% Width_canyon	=	20.0;				% Canyon (road) width (m)
% Width_roof		=	19.68;				% Roof width (m), calculated from the land cover fraction and the street width.
% Radius_tree		=	1.25;				% Tree-crown radius (m), Calculated out of rescaled tree fraction and street width (assuming two uniform strips of tree rows)
% Height_tree		=	7.25;		% Tree height (m)
% Distance_tree	=	5.0;	% Tree-to-wall distance (m)
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ROOF %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fveg_R	=	0.0;	% Vegetated roof raction (-)
% fimp_R	=	1.0;	% Impervious roof fraction (-)
% 
...
% GROUND %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fveg_G	=	0.37;	% Vegetated ground fraction (-)
% fbare_G	=	0.0;	% Bare ground fraction (-)
% fimp_G	=	0.63;	% Impervious ground fraction (-)
% 
...
% ebare_G		=	0.95;	% Ground surface emissivity (-)
...
% 
% 
% emissivity_W	=	0.85;	% Wall emissivity (-)
% 
...
% lan_dry_W	=	0.84;			% Thermal conductivity dry solid [W/m K]
% cv_s_W		=	1.54*10^6;		% Volumetric heat capacity solid [J/m^3 K]
% 
...
ACon        = 0; % Turn AC on and off (on = 1, off = 0)
