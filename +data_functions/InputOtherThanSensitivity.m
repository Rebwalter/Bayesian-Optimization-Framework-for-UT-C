...
function[WallLayers,ParSoilRoof,ParSoilGround,ParInterceptionTree,...
    ...
    PropOpticalIndoors,ParThermalBulidingInt,ParWindows,ParHVAC,BEM_on]=InputOtherThanSensitivity(MeteoData,varargin)
