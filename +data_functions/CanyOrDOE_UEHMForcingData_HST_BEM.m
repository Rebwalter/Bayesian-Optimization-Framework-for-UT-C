...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
phi				=	52.2709046;			% latitude positive north (degrees)
lambda			=	10.5420168;			% longitude positive east (degrees)
theta_canyon	=	deg2rad(CanyOr);	% canyon orientation (rad)
...
%% Meteorological data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Zatm			=	25.60;						% Atmospheric reference height [m]
