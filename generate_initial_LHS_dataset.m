...
%   3. Peak UTCI
%
% The resulting dataset is the initial training archive consumed by
% run_parego_BO_10runs.m (each of the 10 independent BO chains starts
% from this same archive).
%
% Required files:
%   - +data/+input/MeteoData_DWD_hourly_RadPart.mat
%   - helper.makeDOE_opt.m
%   - UTC.m
%
% Outputs (saved to +data/+results/Initial_LHS_Dataset.mat):
%   - DOE, Params, MeteoData, Name_Site
%   - y_night, y_peak, y_UTCI_peak, y_all
%   - Results2m, UTCI
