...
if ittn==1
	Meteo_ittm.SWRin	=	[SWRin(1,:,1); SWRin(ittn,:,1)]; 
    Meteo_ittm.Rain	    =	[MeteoDataRaw.rain(1,:,1); MeteoDataRaw.rain(ittn,:,1)];
else
	Meteo_ittm.SWRin	=	[SWRin(ittn-1,:,1); SWRin(ittn,:,1)]; 
    Meteo_ittm.Rain	    =	[MeteoDataRaw.rain(ittn-1,:,1); MeteoDataRaw.rain(ittn,:,1)];
end
