function[EnergyFluxUrban,EnergyFluxCan,EnergyFluxRoof]=PlanAreaEnergyBalanceCalculation(ViewFactor,MeteoDataRaw,...
    ...
    geometry_Out,FractionsGround_Out,PropOpticalRoof_Out,Anthropo,Gemeotry_m_Out,Figure,ittm,BEM_on)
...
QanthACcondensation =  BEMWasteHeat.WaterFromAC_Can(:,1,ittm).*geometry_Out(ittm).wcanyon_norm;
